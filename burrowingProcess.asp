...
Burrower Name: <input type="text" name="burrowerName" required/><br>
Book Name: <select name="bookName" required>
<!--    select     -->
<%
    sql2 = "SELECT bookName FROM BurrowingProcess" %>
    <%=sql2 %>
...
Burrow Date: <input type="date" name="burrowDate" required/><br>
